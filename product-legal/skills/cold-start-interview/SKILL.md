...
| Children's data | 1/10 | **Blocked pending full review** | "School district pilot — LGPD art. 14 / ECA review first" |
...
|---|---|---|
| [e.g., Children's data] | [e.g., LGPD art. 14 / ECA + we're not set up for it] | [Full review, parental consent flow] |
