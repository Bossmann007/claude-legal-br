...
- **Brazil:** No discovery regime and no work-product doctrine exist under Brazilian law. The closest analog is *sigilo profissional do advogado* / prerrogativa da defesa under the Estatuto da OAB (Lei 8.906/1994), art. 7º, II e XIX, which protects attorney-client communications and the advogado's own case analysis from disclosure and search. It is narrower than US work product: a CADE dawn raid, or a court order under CPC arts. 396-404 (exibição de documento), can still compel production of certain documents, subject to the refusal grounds in art. 404 (e.g., matters covered by professional secrecy). Asserting "attorney work product" on a Brazilian document invokes a US concept a Brazilian court or regulator has no obligation to recognize.
