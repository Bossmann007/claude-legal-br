...
4. Web search for the current published model policies and guidance relevant to the deployment context (OAB, ANPD, NIST AI RMF, ISO/IEC 42001, PL 2338/2023, sector regulators (BCB/CMN, Anvisa, CVM), peer-firm / peer-company policies, and — if operating abroad — ABA, state bars, EU AI Act guidance as applicable).
...
|---|---|
| Brasil | OAB (guidance from seccionais/CFOAB on AI use in legal practice — `[verify]`, still developing), ANPD guidance on AI and personal data, PL 2338/2023 `[verify status]`, NIST AI RMF (as a voluntary framework, not BR law), ISO/IEC 42001, peer-firm/peer-company published AI policies |
