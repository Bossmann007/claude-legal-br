...
2. **Show the customizable map.** List what's in the profile, grouped, with a
   ...
   - **Company / who you are** — name, industry, jurisdictions, stage, practice
     ...
     `company-profile.md`)*
   - **Regulatory footprint** — LGPD, PL 2338/2023, sector regulators (BCB/CMN,
     Anvisa, CVM), plus EU AI Act / state AI laws if operating abroad
   ...
   - **AI system inventory** — per-system role (fornecedor/desenvolvedor,
     operador/implementador, distribuidor) and risk tier under PL 2338/2023
     (plus EU AI Act tier if operating in the EU). Run
     `/ai-governance-legal:ai-inventory` for the dedicated editor.
