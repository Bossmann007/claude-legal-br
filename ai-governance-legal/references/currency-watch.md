...
## Brasil (primary jurisdiction — check first)

| Topic | Instrument | Status | Verify |
|---|---|---|---|
| Marco legal da IA | PL 2338/2023 | Aprovado no Senado em 2024; segue em tramitação na Câmara dos Deputados. Numeração de artigos muda a cada substitutivo. `[verificar status atual]` | [Câmara dos Deputados](https://www.camara.leg.br), [Senado Federal](https://www.senado.leg.br) |
| Decisão automatizada | LGPD (Lei 13.709/2018), Art. 20 | Em vigor — direito a revisão de decisão automatizada que afete o titular. Regulamentação detalhada pode vir por Resolução ANPD. | [ANPD](https://www.gov.br/anpd) |
| Crédito / scoring com IA | Res. CMN/BCB 4.658 e correlatas | Em vigor para instituições financeiras — verificar atualizações específicas para IA em análise de crédito. | [BCB](https://www.bcb.gov.br) |
| Software como dispositivo médico com IA | RDC Anvisa | Em vigor para SaMD em geral — verificar se há norma específica para componente de IA. | [Anvisa](https://www.gov.br/anvisa) |
| Consultoria automatizada de investimentos | Normas CVM (robo-advisors) | Verificar norma vigente. | [CVM](https://www.gov.br/cvm) |

*DOU (Diário Oficial da União) has no single structured API — it's RSS/scraping-based across seções I/II/III, plus per-agency gov.br portals (ANPD, BCB, Anvisa, CVM). No unified endpoint exists.*

## US state AI laws — for companies with US footprint (enacted, effective dates shifting)
...
## EU AI Act implementation — for companies with EU footprint
...
## Federal (US) — for companies with US footprint
