...
- **Before your first citation-heavy session, connect a research tool if you have one.** Say: "Before your first IRAC practice or case brief that leans on citations: if you have a research connector (JusBrasil, Escavador), wire it up. Without one, I'll flag every citation as unverified — cross-check against your vade mecum or cursinho preparatório. In Cowork: Settings → Connectors."
