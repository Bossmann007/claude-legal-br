...
description: >
  ...
  (Relatório de Impacto à Proteção de Dados, LGPD art. 38) or GDPR DPIA, or can
  proceed — surfaces privacy policy conflicts and routes to the right
...
3. House trigger check → mandatory RIPD check (LGPD art. 38 — always applicable) / GDPR DPIA check (if GDPR also in footprint) → privacy policy conflict check.
...
If **any** applicable regime's mandatory trigger is met → **DPIA MANDATORY** (Relatório de Impacto à Proteção de Dados — RIPD, LGPD art. 38 + Res. CD/ANPD nº 18/2024 — or the equivalent regime-specific mandate), regardless of house trigger.
