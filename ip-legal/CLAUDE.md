...
| Legal research (JusBrasil, Escavador, PJe — placeholder, no MCP connector wired up yet) | [PLACEHOLDER ✓/✗] | Manual research — the skill will tell you which cases to pull |
...
**Cabeçalho de sigilo profissional** (anteposto a toda análise, memorando, revisão ou parecer gerado por este plugin). O cabeçalho varia conforme o Role e — para Agentes da Propriedade Industrial — conforme o tipo de matéria, porque o alcance do sigilo varia:

- Se Role é Advogado(a): `CONFIDENCIAL — SIGILO PROFISSIONAL (ADVOGADO-CLIENTE) — PREPARADO SOB ORIENTAÇÃO DA ASSESSORIA JURÍDICA`
- Se Role é Agente da Propriedade Industrial registrado no INPI (Lei 9.279/1996 art. 216) E a matéria é procedimento perante o INPI (depósito, exame, oposição, recurso administrativo): `SIGILO PROFISSIONAL LIMITADO — ATUAÇÃO PERANTE O INPI (Lei 9.279/1996 art. 216) — NÃO EQUIVALE A SIGILO ADVOGADO-CLIENTE (Estatuto OAB)`
- Se Role é Agente da Propriedade Industrial E a matéria NÃO é procedimento perante o INPI (marca, direito autoral, OSS, segredo industrial, contrato, litígio): `NOTAS DE PESQUISA — SEM SIGILO PROFISSIONAL — ATUAÇÃO DE AGENTE DA PROPRIEDADE INDUSTRIAL NÃO ALCANÇA MATÉRIA FORA DO INPI — REVISAR COM ADVOGADO INSCRITO NA OAB ANTES DE AGIR`
- Se Role é Não-advogado (com ou sem acesso a advogado): `NOTAS DE PESQUISA — NÃO CONSTITUI PARECER JURÍDICO — REVISAR COM ADVOGADO INSCRITO NA OAB ANTES DE AGIR`

**A proteção do cabeçalho depende da base e da natureza de quem assina.** No Brasil, sigilo profissional do advogado decorre do Estatuto da OAB (Lei 8.906/1994, art. 7º II e XIX, art. 34 VII) e protege comunicações e trabalho preparado sob orientação de advogado inscrito. Ele NÃO se estende automaticamente a:

- **Documentos internos de RH/marketing/produto** sem envolvimento substantivo de advogado — um memorando de marca redigido só pela equipe de branding não vira sigiloso por ter um cabeçalho.
- **Atuação do Agente da Propriedade Industrial** (Lei 9.279/1996 art. 216) — o agente não-advogado que representa o titular perante o INPI tem prerrogativas de representação processual administrativa, mas isso não é sigilo profissional advogado-cliente. Fora do procedimento no INPI (ex.: enforcement, contratos, litígio civil), a atuação do agente não tem cobertura de sigilo alguma — precisa de advogado.
- **Fiscalização do INPI/órgãos públicos:** não há doutrina equivalente ao "attorney work product" americano no direito brasileiro — o que existe é sigilo profissional (relação advogado-cliente) e, em menor medida, cláusulas contratuais de confidencialidade, que protegem terceiros mas não o Estado no exercício de poder de polícia.

**Quando a abrangência da matéria incluir jurisdição estrangeira (registro internacional, Protocolo de Madrid, PCT/EPO),** ajustar o cabeçalho:
- Manter `CONFIDENCIAL` (marcação de confidencialidade tem sentido em qualquer sistema).
- Acrescentar nota de jurisdição: `[Nota: sigilo profissional é regime brasileiro (Estatuto OAB). Proteções em [jurisdição] diferem — confirmar o regime de sigilo/privilege aplicável antes de usar esta marcação para blindar o documento de disclosure.]`

Uma falsa garantia de proteção é pior que nenhuma marcação. O advogado que confia em "SIGILO PROFISSIONAL" para blindar um memorando de marketing do MTE/INPI/Justiça é o advogado que perde o argumento.

Remover o cabeçalho de deliverables voltados para fora (notificações extrajudiciais enviadas a contrapartes, notificações de retirada de conteúdo enviadas a provedores, resumos para stakeholders encaminhados fora do jurídico) — ver instruções do skill específico. Confirmar a marcação correta para a jurisdição e matéria.

**Nota sobre alcance do Agente da Propriedade Industrial.** A representação do Agente da Propriedade Industrial (Lei 9.279/1996 art. 216, regulamentação INPI) é estreita: cobre atos de representação perante o INPI em procedimentos de depósito, exame, oposição e recurso administrativo. Não alcança marca fora do INPI, direito autoral, segredo industrial, contrato geral, ou conselho de litígio. Skills rodando em matérias fora do INPI para um usuário Agente da Propriedade Industrial devem marcar outputs `SEM SIGILO PROFISSIONAL`, não sigiloso — uma marcação falsa de sigilo cria admissão descartável em eventual disclosure.
...
If everything is green (research tool connected, full read, no flags, currency checked), collapse to one line: `⚠️ Reviewer note: JusBrasil verified · full read · no flags · ready for your eyes`. Don't pad with bullets that all say "no issues."
...
- `[JusBrasil]` / `[Escavador]` / `[PJe]` / `[INPI]` / `[statute / regulator site]` / `[user provided]` — where a cite actually came from. Provenance, not confidence. Only use these when the cite literally appeared in that source in this session.
...
A reviewer-note shorthand like "JusBrasil verified" is honest only when a research tool actually returned the cite — it describes what the tool did, not what the skill's output is. The skill's output is never "verified" by the skill itself; the reader is what verifies.
...
**Mix de áreas de atuação:** [PLACEHOLDER — marca / direito autoral / patente / segredo industrial / open source / todas. Em quais você atua de fato?]

**Registrado em:** [PLACEHOLDER — jurisdições onde há registros: INPI (Brasil), USPTO, EUIPO, UKIPO, países-membro do Protocolo de Madrid (Brasil aderiu em 2019, Decreto 10.033/2019), depósitos nacionais específicos, PCT/EPO. Ser específico.]

**Sistema de gestão de PI:** [PLACEHOLDER — Anaqua / CPA Global / PatSnap / Clarivate IPfolio / e-INPI / planilha / nenhum]

**Titularidade por área:**
- Marca: [PLACEHOLDER — nome/equipe ou escritório terceirizado]
- Patente: [PLACEHOLDER — nome/equipe ou escritório terceirizado, ou Agente da Propriedade Industrial registrado no INPI]
- Direito autoral: [PLACEHOLDER — nome/equipe ou escritório terceirizado]
- Segredo industrial: [PLACEHOLDER — nome/equipe]
- Open source: [PLACEHOLDER — nome/equipe — geralmente engenharia com aval jurídico]

**Escritórios/agentes externos:**

| Área | Tipo de trabalho | Escritório / profissional |
|---|---|---|
| Prosecução de marca (INPI) | [PLACEHOLDER] | [PLACEHOLDER] |
| Prosecução de patente (INPI/agente da PI) | [PLACEHOLDER] | [PLACEHOLDER] |
| Litígio de PI | [PLACEHOLDER] | [PLACEHOLDER] |
| Associados internacionais / correspondentes estrangeiros | [PLACEHOLDER] | [PLACEHOLDER] |

---

## Portfólio de PI

**Registro:** `~/.claude/plugins/config/claude-for-legal/ip-legal/portfolio.yaml`

*O registro guarda cada marca, patente e direito autoral que a equipe acompanha, com jurisdição, número de processo INPI (ou estrangeiro), datas de prorrogação/vigência e status. Construído no cold-start a partir do sistema de gestão de PI (se conectado) ou de exports fornecidos pelo usuário. Atualizado por `/ip-legal:portfolio` e consumido pelo agente de renovação.*

**Data da última auditoria:** [PLACEHOLDER — AAAA-MM-DD]

**Alertas de prorrogação vão para:** [PLACEHOLDER — canal Slack, e-mail, ou só inline]

---

## Proteção de marca

**Marcas monitoradas:** [PLACEHOLDER — lista de marcas monitoradas para uso por terceiros/possível infração. Se nenhuma, dizer "nenhuma — só reativo."]

**Jurisdições de monitoramento:** [PLACEHOLDER — Brasil (INPI) / Mercosul / global via serviço de vigilância]

**Serviço de vigilância:** [PLACEHOLDER — Corsearch / CompuMark / interno / nenhum]

**Periodicidade de monitoramento:** [PLACEHOLDER — semanal / mensal / trimestral / sob demanda]

---

## Postura de enforcement

**Postura padrão:** [PLACEHOLDER — agressiva / moderada / conservadora]

*Agressiva = enviar notificação extrajudicial cedo ante infração aparente, disposto a ajuizar. Moderada = começar com carta branda ou contato informal, escalar só se ignorado ou impacto comercial for real. Conservadora = só afirmar direito quando o ajuizamento for provável e o negócio já autorizou a briga.*

**Quando enviamos notificação extrajudicial (equivalente ao C&D):** [PLACEHOLDER — descrever o gatilho: confusão provável + dano comercial? qualquer uso de marca registrada no INPI? só quando notificação de retirada de conteúdo não resolver?]

**Quando enviamos carta branda primeiro:** [PLACEHOLDER — ex.: "infrator pessoa física, contraparte com quem há relação comercial, uso comercial pequeno"]

**Quando só ajuizamos (ação de abstenção/indenização, Lei 9.279/1996 art. 129, 189-210):** [PLACEHOLDER — ex.: "infrator reincidente que ignorou notificações anteriores", "contraparte com disposição conhecida de litigar"]

**Aprovação para enviar carta de afirmação de direito (notificação extrajudicial, carta branda, notificação de retirada de conteúdo):**

| Tipo de carta | Aprovador | Gatilho de escalonamento |
|---|---|---|
| Notificação de retirada de conteúdo (ordinária) | [PLACEHOLDER — ex.: assessoria de PI] | [PLACEHOLDER — ex.: contranotificação recebida] |
| Carta branda | [PLACEHOLDER] | [PLACEHOLDER] |
| Notificação extrajudicial (C&D) | [PLACEHOLDER — tipicamente diretoria jurídica ou head de PI] | [PLACEHOLDER] |
| Ajuizamento de ação | [PLACEHOLDER — diretoria jurídica + CEO/sponsor do negócio] | [PLACEHOLDER] |

**Escalonamentos automáticos independente do aprovador padrão:**
- [PLACEHOLDER — ex.: "contraparte é cliente ou parceiro atual"]
- [PLACEHOLDER — ex.: "contraparte é maior/mais capitalizada — poderíamos perder"]
- [PLACEHOLDER — ex.: "afirmação envolve patente, não marca"]
- [PLACEHOLDER — ex.: "qualquer coisa que possa atrair imprensa"]
...
1. **Provenance tags describe what happened, not what you'd like to claim.** Tag a citation with the MCP source (e.g., `[JusBrasil]`) only when the citation literally appeared in that tool's result this session. Model knowledge that "feels" like a JusBrasil result is `[model knowledge — verify]`.
