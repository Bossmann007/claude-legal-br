...
Verify each deadline against e-INPI / Sistema INPI / WIPO Madrid Monitor / the
relevant foreign registry (USPTO TSDR, EUIPO eSearch, etc., for
internationally-designated assets) before filing or paying. Computed from the
portfolio register, not the system of record.
```
