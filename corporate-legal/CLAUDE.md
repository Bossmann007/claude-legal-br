...
# Perfil de Prática Jurídica Corporativa
*Escrito por cold-start em [DATA]. Módulos ativos: [M&A | Conselho & Secretaria | Empresa Pública | Gestão de Entidades]*
*Se `[PLACEHOLDER]`, execute `/corporate-legal:cold-start-interview`.*

---

## Company profile

**Nome da entidade:** [PLACEHOLDER] *(De company-profile.md — edite lá para alterar em todos os plugins)*
**Setor / indústria:** [PLACEHOLDER] *(De company-profile.md — edite lá para alterar em todos os plugins)*
**Fase:** [PLACEHOLDER — privada / pública / subsidiária de pública]
**Jurisdição primária:** [PLACEHOLDER] *(De company-profile.md — edite lá para alterar em todos os plugins)*
**Tamanho do time jurídico:** [PLACEHOLDER] *(De company-profile.md — edite lá para alterar em todos os plugins)*
**Escalação:** [PLACEHOLDER — escritório de advocacia externo, nome do GC, ou caminho de escalação para conselho]

**Ambiente de prática:** [PLACEHOLDER — Solo/pequeno escritório | Escritório médio/grande | In-house | Governo/assistência jurídica/clínica] *(De company-profile.md — edite lá para alterar em todos os plugins)*
...
> "You mentioned a prazo prescricional de 5 anos para verbas trabalhistas — meu entendimento é que a prescrição trabalhista é de 2 anos após a extinção do contrato, limitada a 5 anos retroativos (art. 7º, XXIX, CF). Pode confirmar o que você quis dizer? `[premise flagged — verify]`"
...
- **`[settled — last confirmed YYYY-MM-DD]`** — stable statutory and regulatory references that have been checked against a primary source on the stated date. The date matters: "stable" references change. A resolução da ANPD sobre transferência internacional de dados mudou os requisitos em 2024, o que teria sido `[settled]` antes disso. O marco legal de IA (PL das IAs) já teve o prazo de vigência adiado mais de uma vez. The date tells the reader when the confidence was earned and whether it's earned it lately. When you can't confirm the date of the last check, use `[model knowledge — verify]` instead — an unconfirmed "settled" is the confident overclaim we built the whole attribution system to prevent.
...
**Nota Brasil:** entidades brasileiras não têm "registered agent" — o equivalente funcional é o(a) advogado(a)/contador(a) responsável pelo registro na Junta Comercial do estado (JUCESP, JUCERJA etc.) e pela manutenção do CNPJ junto à Receita Federal. Tipo societário mais comum: Sociedade Limitada (Ltda., Código Civil Arts. 1.052-1.087) ou Sociedade Anônima (S.A., Lei 6.404/1976). Cada entidade brasileira ativa deve ter: CNPJ ativo, Contrato Social (Ltda.) ou Estatuto Social (S.A.) registrado, e alterações contratuais registradas na Junta Comercial em até 30 dias do ato (Art. 36, Lei 8.934/1994) para preservar eficácia perante terceiros.
...
|---|---|---|---|---|---|
| [PLACEHOLDER] | [Ltda./S.A./Corp/LLC] | [PLACEHOLDER] | [PLACEHOLDER] | [PLACEHOLDER] | [Ativa/Dormant] |
