...
|---|---|---|---|---|
| [`reg-monitor`](./reg-monitor/) | regulatory-legal | Regulatory feeds (DOU + per-agency gov.br portals — ANPD, BCB/CMN, ANVISA, ANATEL, ANEEL, ANS, CADE depending on context) | `Check feeds as-of <date>, materiality: <threshold>` | feed-reader · materiality-filter · **digest-writer** |
...
| [`docket-watcher`](./docket-watcher/) | litigation-legal | Court dockets (JusBrasil, Escavador, PJe) for new filings, deadlines, and deliverables | `Watch docket <case-id> in <court>, matter <matter-id>` | docket-reader · deadline-mapper · **tracker-writer** |
