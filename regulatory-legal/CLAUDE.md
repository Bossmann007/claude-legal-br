...
|---|---|---|
| Regulatory feeds (paid subscription) | [✓ / ✗] | DOU (Diário Oficial da União) + gov.br agency portals + user-pasted alerts; no enrichment layer, no unified API |
...
*DOU is NOT a single structured API like Federal Register — it's RSS/scraping-based across seções I/II/III, plus per-agency gov.br portals (ANPD, BCB/CMN, ANVISA, ANATEL, ANEEL, ANS, CADE). No unified endpoint exists; see `references/source-catalog.md` `[verify]`.*
...
**JusBrasil / Escavador / PJe:** [PLACEHOLDER]
**Direct regulator feeds:** [PLACEHOLDER — DOU seções I/II/III, gov.br agency RSS/email lists]
