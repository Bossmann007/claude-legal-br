...
**Nota LGPD (Art. 39 e 42 §1º):** contrato de tratamento anexo deve fixar quem é controlador e quem é operador (Art. 5º VI/VII LGPD) e prever responsabilidade solidária do operador que descumprir instruções lícitas do controlador (Art. 42 §1º). Ver playbook do plugin `privacy-legal` para revisão detalhada do DPA — este plugin trata só a cláusula de proteção de dados dentro do contrato comercial maior.
...
**Preferred:** [PLACEHOLDER — ex.: "Comarca de São Paulo/SP, foro de eleição, Art. 63 CPC"]
**Acceptable:** [PLACEHOLDER]
**Escalate:** [PLACEHOLDER]
**Never:** [PLACEHOLDER — ex.: aceitar foro no domicílio do comprador sem justificativa comercial, ou cláusula de eleição de foro que viole Art. 63, §3º CPC quando houver parte hipossuficiente]

**Nota sobre lei aplicável:** contratos empresariais no Brasil regem-se primariamente pelo Código Civil (Lei 10.406/2002, Livro I da Parte Especial — Direito das Obrigações e dos Contratos, Arts. 421-480) e, se houver parte consumidora, pelo CDC (Lei 8.078/1990) de forma cogente e irrenunciável — cláusula de eleição de foro ou de lei estrangeira não afasta o CDC quando a relação é de consumo (Art. 51, CDC — nulidade de cláusulas abusivas). Cláusula de arbitragem é válida (Lei 9.307/1996) mas inaplicável a relações de consumo com consumidor hipossuficiente sem sua iniciativa (Art. 51, VII CDC).

#### O ponto inegociável

[PLACEHOLDER — cláusula que quebra o negócio quando somos vendedores. Toda revisão do lado de venda checa isso primeiro.]
...
**Nota LGPD (Art. 39 e 42 §1º):** ao contratar fornecedor que trata dados por nossa conta, exigir cláusula que o qualifique como operador (Art. 5º VII LGPD), com obrigação de seguir instruções lícitas do controlador e responsabilidade solidária em caso de descumprimento (Art. 42 §1º). Ver playbook do plugin `privacy-legal` para termo a termo.
...
**Preferred:** [PLACEHOLDER — ex.: "Comarca do domicílio do comprador, ou foro neutro acordado"]
**Acceptable:** [PLACEHOLDER]
**Escalate:** [PLACEHOLDER]
**Never:** [PLACEHOLDER — ex.: aceitar foro de eleição em comarca distante sem poder de barganha, cláusula que afaste aplicação do CDC quando somos parte hipossuficiente]

**Nota sobre lei aplicável:** mesma base do lado de venda — Código Civil (Arts. 421-480) para relação empresarial pura; CDC cogente quando a empresa compradora se enquadra como consumidora final (destinatária final do produto/serviço, sem repasse). Verificar enquadramento consumerista antes de aceitar cláusula de eleição de foro do fornecedor.

#### O ponto inegociável

[PLACEHOLDER — cláusula que quebra o negócio quando somos compradores. Toda revisão do lado de compra checa isso primeiro.]
...
- **Brasil:** não existe "attorney work product" no direito brasileiro. A proteção análoga é o **sigilo profissional do advogado** (Art. 7º, XIX, Estatuto da OAB — Lei 8.906/1994; Art. 34-36, Código de Ética e Disciplina da OAB), que protege comunicações e documentos produzidos por advogado inscrito na OAB no exercício da profissão, e a inviolabilidade de seus arquivos e comunicações (Art. 7º, §6º-B). Essa proteção só se aplica quando o documento foi efetivamente produzido ou supervisionado por advogado(a) com inscrição ativa na OAB — análises internas conduzidas só por profissionais não-advogados (compliance, paralegal) não geram sigilo profissional, mesmo com o marcador aplicado.
