...
- **Exclusão de responsabilidade:** nula se a relação for de consumo (Art. 51, I CDC — nulidade de cláusula que exonere responsabilidade por vício/defeito); entre empresas, válida dentro dos limites de boa-fé objetiva (Art. 422 CC). [model knowledge — verify]
